 ...
 * @author Lari Sousa
 */
public class QuimicaBasicaQuest1 extends javax.swing.JFrame {

    /**
     * Creates new form QuimicaBasicaQuest1
     */
    public QuimicaBasicaQuest1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Uma solução aquosa de H3PO4 é ácida devido à presença de:");
    ...
    private void btnProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProximoActionPerformed
        QumicaBasicaQuest2 AbrirInicio = new QumicaBasicaQuest2();
        AbrirInicio.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuimicaBasicaQuest1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuimicaBasicaQuest1().setVisible(true);
            }
        });
    }
