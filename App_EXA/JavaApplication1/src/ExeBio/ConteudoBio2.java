...
import Biologia.BiologiaAvancada;
 ...
 * @author Lari Sousa
 */
public class ConteudoBio2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Biologia avançada");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       BiologiaAvancada Abrir = new BiologiaAvancada();
...
AbrirInicio.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConteudoBio2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConteudoBio2().setVisible(true);
            }
        });
    }
